...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow5 = ((sqrtf(fSlow0) * sinf(fSlow1)) / max(0.001f, fslider2));
		float 	fSlow6 = (1 + (fSlow4 + fSlow5));
		float 	fSlow7 = (1.0f / fSlow6);
		float 	fSlow8 = ((1 + fSlow4) - fSlow5);
		float 	fSlow9 = (1 + fSlow0);
		float 	fSlow10 = (fSlow0 * (0 - ((fSlow3 + fSlow5) - fSlow9)));
		float 	fSlow11 = (fSlow9 * fSlow2);
		float 	fSlow12 = (0 - (2 * ((fSlow0 + fSlow11) - 1)));
		float 	fSlow13 = (fSlow0 / fSlow6);
		float 	fSlow14 = ((1 + (fSlow0 + fSlow5)) - fSlow3);
		float 	fSlow15 = (2 * (0 - ((1 + fSlow11) - fSlow0)));
		FAUSTFLOAT* input0 = input[0];
		FAUSTFLOAT* output0 = output[0];
		for (int i=0; i<count; i++) {
			fRec0[0] = (fSlow7 * (fSlow8 - ((fSlow10 * fRec0[1]) + (fSlow12 * fRec0[2]))));
			output0[i] = (FAUSTFLOAT)(((float)input0[i] * fRec0[0]) + (fSlow13 * ((fSlow14 * fRec0[1]) + (fSlow15 * fRec0[2]))));
			// post processing
