...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow1 = (1.0f / (1 + (fSlow0 * (1.4142135623730951f + fSlow0))));
		float 	fSlow2 = powf(10,(0.05f * fslider0));
		float 	fSlow3 = sqrtf((2 * fSlow2));
		float 	fSlow4 = (fSlow2 * fSlow0);
		float 	fSlow5 = (1 + (fSlow0 * (fSlow3 + fSlow4)));
		float 	fSlow6 = (1 + (fSlow0 * (fSlow0 - 1.4142135623730951f)));
		float 	fSlow7 = faustpower<2>(fSlow0);
		float 	fSlow8 = (2 * (fSlow7 - 1));
		float 	fSlow9 = (2 * ((fSlow2 * fSlow7) - 1));
		float 	fSlow10 = (1 + (fSlow0 * (fSlow4 - fSlow3)));
		FAUSTFLOAT* input0 = input[0];
		FAUSTFLOAT* output0 = output[0];
		for (int i=0; i<count; i++) {
			fRec0[0] = ((float)input0[i] - (fSlow1 * ((fSlow6 * fRec0[2]) + (fSlow8 * fRec0[1]))));
			output0[i] = (FAUSTFLOAT)(fSlow1 * (((fSlow5 * fRec0[0]) + (fSlow9 * fRec0[1])) + (fSlow10 * fRec0[2])));
			// post processing
